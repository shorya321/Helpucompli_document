...
The dashboard is the main interface at docs.helpucompli.com after authentication. Shows summary metrics, recent activity, and quick action buttons. Only accessible to users with `super_admin`, `admin`, or `viewer` roles.
