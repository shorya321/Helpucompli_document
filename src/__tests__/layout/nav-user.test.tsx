...
describe("NavUser", () => {
  ...
  it("opens the menu and exposes a sign-out anchor to /api/auth/audit-logout", async () => {
    ...
    // Routes through the audit-logout API so the LOGOUT row is written
    // before Auth0 SDK clears the session at /auth/logout.
